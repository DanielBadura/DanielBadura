...
- [symfony/serializer](https://github.com/symfony/serializer) ([v6.2.8](https://github.com/symfony/serializer/releases/tag/v6.2.8), 3 days ago) - Handles serializing and deserializing data structures, including object graphs, into array structures or other formats like XML and JSON.
- [symfony/symfony](https://github.com/symfony/symfony) ([v6.2.8](https://github.com/symfony/symfony/releases/tag/v6.2.8), 3 days ago) - The Symfony PHP framework
- [Roave/BackwardCompatibilityCheck](https://github.com/Roave/BackwardCompatibilityCheck) ([8.3.0](https://github.com/Roave/BackwardCompatibilityCheck/releases/tag/8.3.0), 1 month ago) - :ab: Tool to compare two revisions of a class API to check for BC breaks
