...
- [patchlevel/hydrator](https://github.com/patchlevel/hydrator) ([1.17.0](https://github.com/patchlevel/hydrator/releases/tag/1.17.0), 1 day ago) - This library enables seamless hydration of objects to arrays—and back again. It’s optimized for both developer experience (DX) and performance.
...
- [patchlevel/event-sourcing-phpunit](https://github.com/patchlevel/event-sourcing-phpunit) ([1.6.0](https://github.com/patchlevel/event-sourcing-phpunit/releases/tag/1.6.0), 2 weeks ago) - PHPUnit testing utilities for patchlevel/event-sourcing
