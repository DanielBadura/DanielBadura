...
- [Roave/BetterReflection](https://github.com/Roave/BetterReflection) ([5.2.0](https://github.com/Roave/BetterReflection/releases/tag/5.2.0), 2 days ago) - :crystal_ball: Better Reflection is a reflection API that aims to improve and provide more features than PHP&#39;s built-in reflection API.
- [phpstan/phpstan-doctrine](https://github.com/phpstan/phpstan-doctrine) ([1.2.11](https://github.com/phpstan/phpstan-doctrine/releases/tag/1.2.11), 6 days ago) - Doctrine extensions for PHPStan
