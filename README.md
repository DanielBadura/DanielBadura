...
- [patchlevel/event-sourcing-phpunit](https://github.com/patchlevel/event-sourcing-phpunit) ([1.7.0](https://github.com/patchlevel/event-sourcing-phpunit/releases/tag/1.7.0), 1 day ago) - PHPUnit testing utilities for patchlevel/event-sourcing
- [patchlevel/hydrator](https://github.com/patchlevel/hydrator) ([1.19.0](https://github.com/patchlevel/hydrator/releases/tag/1.19.0), 5 days ago) - This library enables seamless hydration of objects to arrays—and back again. It’s optimized for both developer experience (DX) and performance.
