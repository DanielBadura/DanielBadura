...
- [patchlevel/hydrator](https://github.com/patchlevel/hydrator) ([1.6.0](https://github.com/patchlevel/hydrator/releases/tag/1.6.0), 1 day ago) - With this library you can hydrate objects from array into objects and back again. 
- [patchlevel/event-sourcing](https://github.com/patchlevel/event-sourcing) ([3.7.0](https://github.com/patchlevel/event-sourcing/releases/tag/3.7.0), 1 day ago) - An event sourcing library, complete with all the essential features,  powered by the reliable Doctrine ecosystem and focused on developer experience.
