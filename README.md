...
- [phpstan/phpstan-doctrine](https://github.com/phpstan/phpstan-doctrine) ([1.3.4](https://github.com/phpstan/phpstan-doctrine/releases/tag/1.3.4), 1 day ago) - Doctrine extensions for PHPStan
- [patchlevel/event-sourcing](https://github.com/patchlevel/event-sourcing) ([2.0.0-beta4](https://github.com/patchlevel/event-sourcing/releases/tag/2.0.0-beta4), 1 week ago) - A lightweight but also all-inclusive event sourcing library with a focus on developer experience and based on doctrine dbal
