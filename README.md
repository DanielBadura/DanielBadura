...
- [Roave/BetterReflection](https://github.com/Roave/BetterReflection) ([5.0.7](https://github.com/Roave/BetterReflection/releases/tag/5.0.7), 1 day ago) - :crystal_ball: Better Reflection is a reflection API that aims to improve and provide more features than PHP&#39;s built-in reflection API.
- [phpstan/phpstan-doctrine](https://github.com/phpstan/phpstan-doctrine) ([1.1.0](https://github.com/phpstan/phpstan-doctrine/releases/tag/1.1.0), 2 days ago) - Doctrine extensions for PHPStan
...
- [patchlevel/event-sourcing](https://github.com/patchlevel/event-sourcing) ([1.2.0](https://github.com/patchlevel/event-sourcing/releases/tag/1.2.0), 1 week ago) - A lightweight but also all-inclusive event sourcing library with a focus on developer experience and based on doctrine dbal
