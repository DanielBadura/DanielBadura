...
- [patchlevel/event-sourcing](https://github.com/patchlevel/event-sourcing) ([2.0.0-beta2](https://github.com/patchlevel/event-sourcing/releases/tag/2.0.0-beta2), 1 day ago) - A lightweight but also all-inclusive event sourcing library with a focus on developer experience and based on doctrine dbal
...
- [Roave/BetterReflection](https://github.com/Roave/BetterReflection) ([5.4.0](https://github.com/Roave/BetterReflection/releases/tag/5.4.0), 6 days ago) - :crystal_ball: Better Reflection is a reflection API that aims to improve and provide more features than PHP&#39;s built-in reflection API.
