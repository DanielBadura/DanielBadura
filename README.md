...
- [laminas/automatic-releases](https://github.com/laminas/automatic-releases) ([1.26.2](https://github.com/laminas/automatic-releases/releases/tag/1.26.2), 1 day ago) - Automated release process for `laminas/` projects, usable as github action
- [patchlevel/event-sourcing](https://github.com/patchlevel/event-sourcing) ([3.17.0](https://github.com/patchlevel/event-sourcing/releases/tag/3.17.0), 1 day ago) - An event sourcing library, complete with all the essential features,  powered by the reliable Doctrine ecosystem and focused on developer experience.
- [patchlevel/hydrator](https://github.com/patchlevel/hydrator) ([1.16.0](https://github.com/patchlevel/hydrator/releases/tag/1.16.0), 1 day ago) - This library enables seamless hydration of objects to arrays—and back again. It’s optimized for both developer experience (DX) and performance.
- [patchlevel/event-sourcing-phpunit](https://github.com/patchlevel/event-sourcing-phpunit) ([1.5.0](https://github.com/patchlevel/event-sourcing-phpunit/releases/tag/1.5.0), 1 day ago) - PHPUnit testing utilities for patchlevel/event-sourcing
- [phpspec/phpspec](https://github.com/phpspec/phpspec) ([8.2.0](https://github.com/phpspec/phpspec/releases/tag/8.2.0), 3 weeks ago) - SpecBDD Framework for PHP
