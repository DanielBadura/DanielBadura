...
- [phpstan/phpstan-doctrine](https://github.com/phpstan/phpstan-doctrine) ([1.2.2](https://github.com/phpstan/phpstan-doctrine/releases/tag/1.2.2), 2 days ago) - Doctrine extensions for PHPStan
- [patchlevel/event-sourcing](https://github.com/patchlevel/event-sourcing) ([1.2.1](https://github.com/patchlevel/event-sourcing/releases/tag/1.2.1), 4 days ago) - A lightweight but also all-inclusive event sourcing library with a focus on developer experience and based on doctrine dbal
- [Roave/BetterReflection](https://github.com/Roave/BetterReflection) ([5.0.7](https://github.com/Roave/BetterReflection/releases/tag/5.0.7), 5 days ago) - :crystal_ball: Better Reflection is a reflection API that aims to improve and provide more features than PHP&#39;s built-in reflection API.
