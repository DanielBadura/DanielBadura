...
- [Roave/BetterReflection](https://github.com/Roave/BetterReflection) ([5.1.0](https://github.com/Roave/BetterReflection/releases/tag/5.1.0), 1 day ago) - :crystal_ball: Better Reflection is a reflection API that aims to improve and provide more features than PHP&#39;s built-in reflection API.
- [phpstan/phpstan-doctrine](https://github.com/phpstan/phpstan-doctrine) ([1.2.10](https://github.com/phpstan/phpstan-doctrine/releases/tag/1.2.10), 2 weeks ago) - Doctrine extensions for PHPStan
