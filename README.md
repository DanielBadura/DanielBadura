...
- [phpstan/phpstan-doctrine](https://github.com/phpstan/phpstan-doctrine) ([1.0.3](https://github.com/phpstan/phpstan-doctrine/releases/tag/1.0.3), 1 day ago) - Doctrine extensions for PHPStan
- [Roave/BetterReflection](https://github.com/Roave/BetterReflection) ([5.0.6](https://github.com/Roave/BetterReflection/releases/tag/5.0.6), 5 days ago) - :crystal_ball: Better Reflection is a reflection API that aims to improve and provide more features than PHP&#39;s built-in reflection API.
