...
- [patchlevel/enum](https://github.com/patchlevel/enum) - Small lightweight library to create enum in PHP without SPLEnum and strict comparisons allowed. (3 days ago)
...
- [phpstan/phpstan-doctrine](https://github.com/phpstan/phpstan-doctrine) ([1.3.0](https://github.com/phpstan/phpstan-doctrine/releases/tag/1.3.0), 1 day ago) - Doctrine extensions for PHPStan
